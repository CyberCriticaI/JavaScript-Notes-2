...
const solarSystem = [
    ...
    console.log(solarSystem[8].moons[0]);
    ...
    solarSystem[2].push(diameter: "7917.5 miles");
    ...
    solarSystem[6].moons.splice[4, "Oberon"];
    ...
    for solarSystem.ringSystem = (let i=0; i===false; i==) {
        console.log(i);
    }
    ...
    let satellitesSum = (system.jupiter.satellites +  system.saturn.satellites + system.uranus.satellites + system.neptune.satellites)
    ...
    if system.mercury.radiusp = typeof("");
    else system.mercury.radiusp
    ...
    let momentumProduct = (momentumJupiter + momentumPluto)
    console.log(momentumProduct);